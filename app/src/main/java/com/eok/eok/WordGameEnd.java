...
import com.eok.eok.databinding.ActivityWordGameEndBinding;
...
public class WordGameEnd extends AppCompatActivity {
    private ActivityWordGameEndBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWordGameEndBinding.inflate(getLayoutInflater());
        ...
        if (score>record)
        {
            ...
            userInfo.put("wordGameRecord",score);
    ...
    {
        Intent intent = new Intent(WordGameEnd.this, MainScreen.class);
        startActivity(intent);
        finish();
    }
    public void again(View v)
    {
        Intent intent = new Intent(WordGameEnd.this, WordGame.class);
